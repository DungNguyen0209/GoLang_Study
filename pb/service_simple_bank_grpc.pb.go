...
type SimpleBankClient interface {
	...
	VerifyEmail(ctx context.Context, in *VerifyEmailRequest, opts ...grpc.CallOption) (*VerifyEmailRespone, error)
}
...
func (c *simpleBankClient) VerifyEmail(ctx context.Context, in *VerifyEmailRequest, opts ...grpc.CallOption) (*VerifyEmailRespone, error) {
	out := new(VerifyEmailRespone)
...
type SimpleBankServer interface {
	...
	VerifyEmail(context.Context, *VerifyEmailRequest) (*VerifyEmailRespone, error)
...
func (UnimplementedSimpleBankServer) VerifyEmail(context.Context, *VerifyEmailRequest) (*VerifyEmailRespone, error) {

...
func (x *VerifyEmailRespone) Reset() {
	*x = VerifyEmailRespone{}
	if protoimpl.UnsafeEnabled {
...
func (x *VerifyEmailRespone) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VerifyEmailRespone) ProtoMessage() {}

func (x *VerifyEmailRespone) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_verify_email_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VerifyEmailRespone.ProtoReflect.Descriptor instead.
func (*VerifyEmailRespone) Descriptor() ([]byte, []int) {
	return file_rpc_verify_email_proto_rawDescGZIP(), []int{1}
}

func (x *VerifyEmailRespone) GetIsVerified() bool {
	if x != nil {
		return x.IsVerified
	}
	return false
...
var file_rpc_verify_email_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x0a, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x35,
	0x0a, 0x12, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x69, 0x73, 0x5f, 0x76, 0x65, 0x72, 0x69, 0x66,
	0x69, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x69, 0x73, 0x56, 0x65, 0x72,
	0x69, 0x66, 0x69, 0x65, 0x64, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_rpc_verify_email_proto_goTypes = []interface{}{
	...
	(*VerifyEmailRespone)(nil), // 1: pb.VerifyEmailRespone
}
...
func file_rpc_verify_email_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_verify_email_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VerifyEmailRespone); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
